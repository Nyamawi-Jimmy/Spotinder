            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusColor: Colors.white, // Set the label color to white when focused
                ),
              ),
              Dimensions.spacesmall,
              TextFormField(
                        ...
                        if(tokenValue.isNotEmpty && tokenValue !=''){
                          ...
                          if (response != null) {
                            try {
                              ...
                              if (items.isNotEmpty) {
                                final Map<String, dynamic> album = items[0]['album'];
                                final String albumName = album['name'];
                                final String albumType = album['album_type'];
                                final int totalTracks = album['total_tracks'];
                                final List<dynamic> availableMarkets = album['available_markets'];
                                final String albumImageUrl = album['images'][0]['url'];
                                ...
                                print('No albums found in the response.');
                              }
                            } catch (e) {
